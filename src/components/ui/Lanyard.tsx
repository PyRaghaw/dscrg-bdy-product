...
// Use <primitive> element with THREE class instances instead of registering JSX elements
...
function Band({
  ...
  const lineGeom = useMemo(() => new MeshLineGeometry(), []);
  const lineMat = useMemo(() => new MeshLineMaterial({ resolution: new THREE.Vector2(1000, 1000) }), []);
